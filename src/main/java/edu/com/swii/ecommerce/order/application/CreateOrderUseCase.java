package edu.com.swii.ecommerce.order.application;

import  edu.com.swii.ecommerce.order.domain.*;
import edu.com.swii.ecommerce.customer.domain.*;
    ...
    public Order execute(CreateOrderRequest request) {
        ...
        for (CreateOrderRequest.OrderItemRequest itemRequest : request.getItems()) {
            ...
            if (!product.isAvailable(itemRequest.getQuantity())) {
                throw new IllegalStateException("Insufficient stock for product: " + productId.getValue());
            }
